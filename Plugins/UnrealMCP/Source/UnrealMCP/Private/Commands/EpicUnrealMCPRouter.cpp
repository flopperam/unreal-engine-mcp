...
int32 FEpicUnrealMCPRouter::RouteCommand(const FString& CommandType)
{
    static const TMap<FString, int32> Router = {
        ...
        {TEXT("set_actor_collision_preset"), 19},
        {TEXT("set_actor_physics"), 19},
        {TEXT("create_physical_material"), 19},
        {TEXT("spawn_radial_force"), 19},
        {TEXT("spawn_physics_constraint"), 19},
        {TEXT("compile_all_blueprints"), 19},
        {TEXT("run_map_check"), 19},
        {TEXT("find_broken_references"), 19},
        {TEXT("create_draft_proxy"), 19},
        {TEXT("update_draft_proxy"), 19},
        {TEXT("delete_draft_proxy"), 19},
        {TEXT("spawn_instance_set"), 19},
        {TEXT("update_instance_set"), 19},
        {TEXT("delete_instance_set"), 19},
        {TEXT("get_instance_set_state"), 19},
        {TEXT("list_instance_sets"), 19},
